...
function renderCanvas(context:CanvasRenderingContext2D) {
  // Canvas Background
  context.fillStyle = 'black';
  context.fillRect(0, 0, width, height);
  ...
  // Score
  context.font = "32px Courier New";
  context.fillText(score[0] as unknown as string, 20, (canvas.height / 2) + 50);
  context.fillText(score[1]as unknown as string, 20, (canvas.height / 2) - 30);
}
